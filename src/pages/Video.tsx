...
const ProblemScene = () => (
  <Scene>
    <div className="max-w-5xl mx-auto text-center">
      <p className="text-primary text-lg mb-6 tracking-widest uppercase animate-fade-in-up">
        The Problem
      </p>
...
const HowItWorksScene = () => (
  <Scene>
    <div className="max-w-6xl mx-auto">
      <p className="text-primary text-lg mb-6 tracking-widest uppercase text-center animate-fade-in-up">
        How It Works
      </p>
    ...
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-700">
        <a
          ...
          className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold bg-primary hover:bg-primary/90 text-white rounded-full transition-all hover:scale-105 shadow-[0_0_30px_rgba(139,92,246,0.5)]"
        >
          Launch App
