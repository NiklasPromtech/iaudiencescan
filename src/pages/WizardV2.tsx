                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight overflow-visible">
                      ...
                      <span className="whitespace-nowrap">
                        ...
                        <span 
                          ...
                          style={{
                            filter: `drop-shadow(0 0 ${Math.min(heroScrollProgress * 4, 1) * 30}px rgba(168, 85, 247, ${Math.min(heroScrollProgress * 4, 1)})) drop-shadow(0 0 ${Math.min(heroScrollProgress * 4, 1) * 60}px rgba(236, 72, 153, ${Math.min(heroScrollProgress * 4, 1) * 0.7}))`,
                          }}
                        >
                          instantly
                        </span>
