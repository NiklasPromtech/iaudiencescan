...
import { Check, Copy, RefreshCw, Users, Wallet, Tags, Coins, ExternalLink } from "lucide-react";
...
const Install = () => {
  ...
  // Mock project/site ID - in production this would come from auth context
  const siteId = "as_" + Math.random().toString(36).substring(2, 10);
