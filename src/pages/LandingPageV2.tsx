    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            <div className="pt-4">
              <Button 
                size="lg" 
                className="text-lg px-10 py-6 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 shadow-[0_0_30px_rgba(168,85,247,0.5),0_0_60px_rgba(236,72,153,0.3)] transition-all duration-300 hover:shadow-[0_0_40px_rgba(168,85,247,0.6),0_0_80px_rgba(236,72,153,0.4)]" 
                asChild
              >
                <Link to="/auth">
          ...
          <div className="mt-16 max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {stats.map((stat, index) => (
                <div 
                  key={index} 
                  className="text-center p-4 rounded-xl bg-white/[0.02] backdrop-blur-sm border border-white/[0.08] hover:border-purple-500/30 transition-all duration-300 hover:scale-[1.02]"
                >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-h2 font-bold mb-4 text-white">Web3 Marketing Is Flying Blind</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {painPoints.map((pain, index) => (
                <div 
                  key={index} 
                  className="bg-white/[0.02] backdrop-blur-sm border border-white/[0.08] rounded-xl p-6 hover:border-purple-500/40 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all duration-300 hover:scale-[1.02]"
                >
                  <h3 className="text-h3 font-semibold text-white mb-4">"{pain.title}"</h3>
                  <ul className="space-y-3">
                    {pain.points.map((point, idx) => (
                      <li key={idx} className="flex items-start gap-2 text-p2 text-white/60">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <h2 className="text-h2 font-bold text-white">Stop Burning Money on Bots</h2>
                <p className="text-p1 text-white/60">
                  Our data has already helped clients save thousands of dollars by identifying 
                  traffic sources sending nothing but bots.
                </p>
                <div className="bg-white/[0.02] backdrop-blur-sm border border-purple-500/30 rounded-xl p-6 shadow-[0_0_30px_rgba(168,85,247,0.1)]">
                  <p className="text-p1 text-white/80 italic">
              ...
              <div className="bg-white/[0.02] backdrop-blur-sm border border-white/[0.08] rounded-xl p-6 space-y-4">
                <h3 className="text-h3 font-semibold text-white mb-4">Bot Detection Signals</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-white/[0.02] border border-white/[0.06] rounded-lg">
                    <span className="text-p2 text-white/70">WebDriver Detected</span>
                    <Badge className="bg-red-500/20 text-red-400 border-red-500/40">Bot</Badge>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-white/[0.02] border border-white/[0.06] rounded-lg">
                    <span className="text-p2 text-white/70">Headless Browser</span>
                    <Badge className="bg-red-500/20 text-red-400 border-red-500/40">Bot</Badge>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-white/[0.02] border border-white/[0.06] rounded-lg">
                    <span className="text-p2 text-white/70">Missing WebGL</span>
                    <Badge className="bg-red-500/20 text-red-400 border-red-500/40">Bot</Badge>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                    <span className="text-p2 text-white/70">All Signals Pass</span>
                    <Badge className="bg-green-500/20 text-green-400 border-green-500/40 animate-pulse">Human</Badge>
                  </div>
                </div>
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-h2 font-bold mb-4 text-white">Everything GA Does, Plus Everything Web3 Needs</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {features.map((feature, index) => (
                <div 
                  key={index} 
                  className="bg-white/[0.02] backdrop-blur-sm border border-white/[0.08] rounded-xl p-6 hover:border-purple-500/40 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all duration-300 hover:scale-[1.02] group"
                >
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg bg-purple-500/10 border border-purple-500/30 group-hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-all duration-300">
                      <feature.icon className="h-6 w-6 text-purple-400" />
                    </div>
                    <div>
                      <h3 className="text-h3 font-semibold mb-2 text-white">{feature.title}</h3>
                      <p className="text-p2 text-white/60 mb-2">{feature.description}</p>
                      <p className="text-p3 text-purple-400">{feature.extra}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="bg-purple-500/20 text-purple-300 border border-purple-500/40 px-4 py-2 mb-4">
                The "Aha" Moment
              </Badge>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="bg-purple-500/10 border-2 border-purple-500/40 rounded-xl p-6 shadow-[0_0_40px_rgba(168,85,247,0.3)] relative overflow-hidden flex flex-col h-full">
                ...
                <div className="space-y-4 font-mono text-sm relative z-10 flex-1 flex flex-col">
                  ...
                  <div className="p-3 bg-black/40 border border-purple-500/40 rounded-lg shadow-[0_0_20px_rgba(168,85,247,0.2)]">
            ...
            <div className="mt-8 text-center">
              <p className="text-p1 text-white/60 max-w-2xl mx-auto">
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-h2 font-bold mb-4 text-white">From First-Party Data to On-Chain Lookalikes</h2>
              <p className="text-p1 text-white/60 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {audienceSteps.map((step, index) => (
                <div key={index} className="flex items-center">
                  <div className="flex flex-col items-center p-4 bg-white/[0.02] backdrop-blur-sm border border-white/[0.08] rounded-xl min-w-[140px] hover:border-purple-500/40 hover:shadow-[0_0_20px_rgba(168,85,247,0.15)] transition-all duration-300">
                    <div className="p-3 rounded-full bg-purple-500/10 border border-purple-500/30 mb-3">
                      <step.icon className="h-5 w-5 text-purple-400" />
                    </div>
                    <h3 className="font-semibold text-white">{step.title}</h3>
                    <p className="text-p4 text-white/50 text-center mt-1">{step.description}</p>
                  </div>
                  {index < audienceSteps.length - 1 && (
                    <ArrowRight className="h-5 w-5 text-purple-500/60 mx-2 hidden md:block" />
                  )}
                </div>
              ))}
            </div>
            ...
            <div className="mt-12 text-center">
              <div className="inline-block bg-purple-500/10 border border-purple-500/30 rounded-xl px-6 py-4 shadow-[0_0_30px_rgba(168,85,247,0.15)]">
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-h2 font-bold mb-12 text-white">Trusted by Leading Web3 Teams</h2>
              ...
              <div className="flex animate-marquee">
                ...
                {clientLogos.map((logo, index) => (
                  <img 
                    ...
                    src={logo.src} 
                    alt={logo.alt}
                    className="h-8 md:h-12 object-contain mx-8 opacity-60 hover:opacity-100 transition-opacity grayscale hover:grayscale-0"
                  />
                ))}
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm border border-purple-500/30 rounded-xl p-8 max-w-2xl mx-auto mt-8 shadow-[0_0_40px_rgba(168,85,247,0.15)]">
              <p className="text-p1 text-white/80 italic mb-6">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <Badge className="bg-purple-500/30 text-purple-200 border border-purple-400/50 px-4 py-2 text-sm font-semibold">
            ...
            <div className="pt-4">
              <Button 
                size="lg" 
                className="text-lg px-12 py-6 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 shadow-[0_0_40px_rgba(168,85,247,0.6),0_0_80px_rgba(236,72,153,0.4)] transition-all duration-300 hover:shadow-[0_0_60px_rgba(168,85,247,0.8),0_0_100px_rgba(236,72,153,0.5)] hover:scale-105" 
                asChild
              >
                <Link to="/auth">
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-h2 font-bold mb-4 text-white">How It Works</h2>
            </div>
              ...
              {howItWorksSteps.map((step, index) => (
                <div key={index} className="text-center group">
                  <div className="relative inline-block mb-6">
                    <div className="w-16 h-16 rounded-full bg-purple-500/10 border border-purple-500/30 flex items-center justify-center mx-auto group-hover:shadow-[0_0_30px_rgba(168,85,247,0.4)] transition-all duration-300">
                      <step.icon className="h-8 w-8 text-purple-400" />
                    </div>
                    <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white flex items-center justify-center text-sm font-bold shadow-[0_0_20px_rgba(168,85,247,0.5)]">
                      {index + 1}
                    </div>
                  </div>
                  <h3 className="text-h3 font-semibold mb-1 text-white">{step.title}</h3>
                  <Badge variant="outline" className="mb-3 text-purple-300 border-purple-500/40 bg-purple-500/10">{step.subtitle}</Badge>
                  <p className="text-p2 text-white/60">{step.description}</p>
                </div>
              ))}
            </div>
          </div>
